...
<div id="myModal" class="modal hide fade" tabindex="-1"  aria-labelledby="myModalLabel" aria-hidden="true" style="width:900px; margin-left:-450px; height:380px;color:#fff;">
				...
				<tr style="height:10px;">
					...
					<td>
						<div class="control-group" style="margin-left:-40px;height:10px;">
							...
							<div class="controls">
								<input type="text" id="createperson" name="createperson" placeholder="订单创建人" style="width:120px;color:#3399cc" readonly="readonly">
				...
				<tr style="height:10px;">
					<td>
						<div class="control-group" style="margin-left:-40px;height:10px;">
							...
							<div class="controls">
								<select id="orderstatus" style="width:120px;color:#3399cc;">
...
$("#flexgrid").flexigrid({
                url : 'order/retrivebyparam?n=&c=&s=1&f=0',
                dataType : 'json',
				singleSelect : true,
                colModel : [ {
                    display : '订单编号',
	...
	{
		var url = "order/retrivebyparam?f=0&n=" + $('#name').val() + "&c=" + $('#cperson').val() + "&s=" + $('#status').val();
